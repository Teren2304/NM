...
<link rel="shortcut icon" href="http://www.example.com/favicon.ico" type="image/x-icon" /> -->
	...
	<meta property="og:image:secure_url" content="https://news-market.info/img/apple-icon-76x76.png" />
...
<div class="content container" id="content" @scroll="onScroll" v-bind:style="'height:'+ windowHeight">
	<ul class="articles">
			...
			<article class="article">
				...
				<div class="article__content">
					<p class="close" title="Закрыть" @click="onClickClose"></p>
						<img v-if="item.news_video !=1 && item.news_img"
						 	 width=auto 
						 	 height=auto 
						     id="article__content__img" 
						     v-bind:realsrc="item.news_img"/>
						<video  v-else-if="item.news_video == 1"
								id="article__content__img" 
...
<aside class="menu showMenu hideMenu" id="menu">
	<ul class="menu__category" v-bind:class="category" v-on:click.prevent>
	    <li class="menu__item">
	      ...
	      <p class="menu__text">Обзор, новостей Украины за <?php echo date("d.m.Y");?>, <span id="timedisplay"></span></p>
	    </li>
	    <li class="menu__item">
